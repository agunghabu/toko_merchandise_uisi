    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            TextFormField(
              decoration: InputDecoration(label: Text("Cari Barang"), icon: Icon(Icons.search)),
    ...
    if (listBarang.isEmpty || listBarang == null) {
      ...
      return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return Card(
            child: ListTile(title: Text(listBarang[index].nama), subtitle: Text(listBarang[index].deskripsi)),
          );
        },
      );
    }
